// A two-layer multi-layer perceptron for MNIST.
// Batch size = 64, hidden size = 512
...
//   tensor<10xf32>
// ) {
//   // TODO: Will need to update this as the API gets solidified.
//   %res:6 = enzyme.autodiff @mnist_mlp(%input_t, %labels, %w0, %b0, %w1, %b1, %w2, %b2) {
//     activity = [
//       #enzyme<activity enzyme_const>,
//       #enzyme<activity enzyme_const>,
//       #enzyme<activity enzyme_out>,
//       #enzyme<activity enzyme_out>,
//       #enzyme<activity enzyme_out>,
//       #enzyme<activity enzyme_out>,
//       #enzyme<activity enzyme_out>,
